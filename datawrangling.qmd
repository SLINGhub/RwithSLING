...
# Importing and Manipulating Tables
...
## Import an Agilent MassHunter CSV file using `SLINGtools`

```{r read MassHunter CSV file}


data_file_path <- here("data/Testdata_Lipidomics_MHQuant_Detailed.csv")
